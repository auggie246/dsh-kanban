...
the remote default branch, per-ticket override to local HEAD, following the
Claude Code / Codex isolation model) keep parallel edits from colliding on
disk. Reversing this later means redesigning the board's whole execution
